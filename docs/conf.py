...
# -*- coding: utf-8 -*-
#
# udm_rest_client documentation build configuration file, created by
...
htmlhelp_basename = "udm_rest_clientdoc"
...
man_pages = [(master_doc, "udm_rest_client", "Python UDM REST Client Documentation", [author], 1)]
